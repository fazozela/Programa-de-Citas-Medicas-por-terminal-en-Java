...
public class UiPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do{
            ...
            //mostrar las fechas de los doctores que dejaron fechas
            //el primer elemento almacenara la numeracion de la lista de fechas
            //el segundo integer indicara el indice de la fecha seleccionada
            ...
            if(response == 1){
                UiMenu.patientLogged.addAppointmentDoctors(doctorSelected, doctorSelected.getAvailableAppointments().get(indexDate).getDate(), doctorSelected.getAvailableAppointments().get(indexDate).getTime());
                showPatientMenu();
            }
