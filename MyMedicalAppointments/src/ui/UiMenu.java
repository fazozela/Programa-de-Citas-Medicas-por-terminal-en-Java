...
public class UiMenu {
    ...
    private static void authUser(int userType){
        ...
        doctors.add(new Doctor("Alejandro Martinez", "ale@hotmail.com"));
        doctors.add(new Doctor("Karen Sosa", "karen@hotmail.com"));
        doctors.add(new Doctor("Rocio Gomez", "rocio@hotmail.com"));
